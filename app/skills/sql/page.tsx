...
export default function SqlDetailPage() {
  return (
    <main className="max-w-6xl mx-auto px-4 md:px-8 py-12 space-y-10">
      <div>
        <Link href="/skills" className="text-sm opacity-80 hover:opacity-100">
          &larr; Back to Skills
        </Link>
      </div>
      ...
      <section>
        ...
        <p className="text-slate-700">
          I&apos;ve built my SQL experience through a combination of professional practice and
          formal coursework. At <strong>SafeNest</strong>, I apply SQL weekly to clean and
          transform data for grant reporting, automate ETL pipelines, and support dashboards.
          This hands-on work taught me how to design practical queries, optimize performance,
          and troubleshoot real-world issues.
        </p>
        <p className="text-slate-700 mt-3">
          At the <strong>College of Southern Nevada (CIT 180: Introduction to Databases)</strong>,
          I learned relational modeling, normalization, and structured query writing (SELECT, JOIN,
          GROUP BY, subqueries, indexes). That foundation complements the applied problem-solving I
          do at work.
        </p>
      ...
      <section>
        ...
        <div className="rounded-lg border bg-white p-4 overflow-x-auto">
          <svg viewBox="0 0 1100 270" className="w-full h-auto" role="img" aria-label="SQL workflow">
            <defs>
            ...
            <rect x="20" y="100" width="180" height="60" rx="8" fill="#dbeafe" stroke="#93c5fd" />
            ...
            <rect x="240" y="90" width="210" height="80" rx="8" fill="#e2e8f0" stroke="#94a3b8" />
            ...
            <rect x="480" y="70" width="220" height="120" rx="8" fill="#dcfce7" stroke="#86efac" />
            ...
            <text x="590" y="140" textAnchor="middle" className="fill-slate-600 text-xs">
              staging to relational model to queries
            </text>

            <rect x="730" y="90" width="160" height="80" rx="8" fill="#ffe4e6" stroke="#fecdd3" />
            ...
            <rect x="920" y="100" width="160" height="60" rx="8" fill="#fef9c3" stroke="#fde68a" />
            ...
            <text x="590" y="210" textAnchor="middle" className="fill-slate-600">
              SQL is the core: persistent storage and relational logic powering clean views to BI
            </text>
          </svg>
        </div>
      </section>
